...
let family = {
  Oscar: Oscar = {
    hobbies: hobbies = {hobbies: "stamps"}
  }, 
  George: George = {
    hobbies: hobbies = {hobbies: 'carpentry'}
  },
  Julie: Julie = {
    hobbies: hobbies = {hobbies: 'baking'}
  }
}
...
function getName(userObj){
  return userObj = user.name// Code here
};
...
function getWeekDay(calendar){
  return calendar = calendar.weekDays[2]// Code here
}
